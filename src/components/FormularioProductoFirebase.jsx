  ...
  const handleSubmit = async (e) => {
    ...
    if (validar === true) {
      try {
        ...
        dispararSweetBasico("Producto agregado", "El producto fue agregado exitosamente", "success", "Cerrar");
      } catch (error) {
        dispararSweetBasico("Error al agregar", error.message, "error", "Cerrar");
      }
    } else {
      dispararSweetBasico("Error en el formulario", validar, "error", "Cerrar");
    }
  };
